  ...
  customCase
    ...
    .addCaseField({
      ...
      list: [
        ...
        { code: 'item_2', label: 'Item 2' },
        { code: 'item_3', label: 'Item 3' },
      ],
    })
...
function getDLCaseConfig(scenario) {
  ...
  customCase
    ...
    .addCaseField({
      id: 'coll',
      type: 'Collection',
      label: 'collection complex in complex with DL',
        ...
        complex_fields: [
          {
            id: 'complexl1',
            type: 'Complex',
            label: 'Complex level 1',
            complex_fields: [{ id: 'dl', type: 'DynamicList', label: 'DL1' }],
          },

          {
            id: 'complexl2',
            type: 'Complex',
            label: 'Complex level 2',
            complex_fields: [{ id: 'dl', type: 'DynamicList', label: 'DL2' }],
          },
        ],
      },
      value: [
        {
          complexDl: {
            complexl1: {
              dl: { value: listItems[1], list_items: listItems },
              dl1: { value: listItems[2], list_items: listItems },
            },
            complexl2: {
              dl: { value: listItems[1], list_items: listItems },
              dl2: { value: listItems[2], list_items: listItems },
            },
          },
        },
      ],
