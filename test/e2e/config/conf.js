...
const config = {
  ...
  params: {
    ...
    caseworker_iac_adm_username: process.env.CASEWORKER_IAC_ADM_USERNAME ? process.env.CASEWORKER_IAC_ADM_USERNAME :'claire_fr_mumford@yahoo.com' ,
    caseworker_iac_adm_password: process.env.CASEWORKER_IAC_ADM_PASSWORD ? process.env.CASEWORKER_IAC_ADM_PASSWORD : 'Nagoya0102',
