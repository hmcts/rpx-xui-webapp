...
import { CancelHearingRequestReasonResolver } from './cancel-hearing-request-reason.resolver';
import { provideHttpClient, withInterceptorsFromDi } from '@angular/common/http';

describe('CancelHearingRequestReasonResolver', () => {
  ...
  beforeEach(() => {
    ...
    providers: [
        ...
        CancelHearingRequestReasonResolver,
        LovRefDataService,
  ...
  it('resolves reference data for the adjourn hearing actual reason list', inject([CancelHearingRequestReasonResolver], (service: CancelHearingRequestReasonResolver) => {
