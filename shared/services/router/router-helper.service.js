...
var RouterHelperService = /** @class */ (function () {
    function RouterHelperService() {
    }
    RouterHelperService.prototype.getUrlSegmentsFromRoot = function (route) {
        return route.pathFromRoot
            .filter(function (r) { return r.url && r.url.length; })
            .reduce(function (acc, r) {
            r.url.forEach(function (url) {
                acc.push(url.path);
            });
            return acc;
        }, []);
