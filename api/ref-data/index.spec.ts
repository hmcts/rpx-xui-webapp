...
describe('RefDataEndpoint', () => {
  ...
  describe('getLocationsByServiceCode', () => {
    ...
    it(
      'should make a get request when calling getLocationsByServiceCode, ' + 'pass the query params and respond appropriately',
      async () => {
        const req = mockReq({
  ...
  describe('getLocations', () => {
    ...
    it('should make a get request when calling getLocations, ' + 'pass the query params and respond appropriately', async () => {
      const req = mockReq({
