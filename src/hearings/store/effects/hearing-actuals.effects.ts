...
export class HearingActualsEffects {
  public getHearingActuals$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap((action: hearingActualsActions.GetHearingActuals) =>
        this.hearingsService.getHearingActuals(action.payload).pipe(
  ...
  public updateHearingActualsStage$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap((action: any) =>
        this.hearingsService.updateHearingActuals(action.payload.hearingId, action.payload.hearingActuals).pipe(
  ...
  public submitHearingActuals$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap((action: any) =>
        this.hearingsService.submitHearingActuals(action.payload).pipe(
