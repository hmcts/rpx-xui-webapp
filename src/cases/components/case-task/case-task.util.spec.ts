...
const task: Task = {
  ...
  description:
    'Click link to proceed to next step [test link next step](/cases/case-details/IA/Asylum/1547652071308205/trigger/editAppealAfterSubmit)',
...
describe('CaseTaskUtil', () => {
  it('should return task id appended to url as querystring with no prior querystring exists in the url', () => {
    ...
    expect(appendedTaskDescription).toEqual(
      'Click link to proceed to next step [test link next step](/cases/case-details/IA/Asylum/1547652071308205/trigger/editAppealAfterSubmit?tid=0d22d838-b25a-11eb-a18c-f2d58a9b7bc6)'
    );
  });
  ...
  it('should return task id appended to url as querystring for multiple urls', () => {
    ...
    expect(appendedTaskDescription).toEqual(
      'first link [first](/first/test/link?tid=0d22d838-b25a-11eb-a18c-f2d58a9b7bc6) second link [second](/second/test/link?tid=0d22d838-b25a-11eb-a18c-f2d58a9b7bc6)'
    );
  });
  ...
  it('should return task id appended to url as querystring for multiple urls already having querystring', () => {
    const taskToCheck = task;
    task.description =
      'first link [first](/first/test/link?abc=123) second link [second](/second/test/link) third link [third](/third/test/link?cde=456)';
    const appendedTaskDescription = appendTaskIdAsQueryStringToTaskDescription(taskToCheck);
    expect(appendedTaskDescription).toEqual(
      'first link [first](/first/test/link?abc=123&tid=0d22d838-b25a-11eb-a18c-f2d58a9b7bc6) second link [second](/second/test/link?tid=0d22d838-b25a-11eb-a18c-f2d58a9b7bc6) third link [third](/third/test/link?cde=456&tid=0d22d838-b25a-11eb-a18c-f2d58a9b7bc6)'
    );
  });
  ...
  it('should return task id appended to url as querystring with already existing querystrings in the url', () => {
    ...
    taskToCheck.description =
      'Click link to proceed to next step [test link next step](/cases/case-details/IA/Asylum/1547652071308205/trigger/editAppealAfterSubmit?abc=123)';
    const appendedTaskDescription = appendTaskIdAsQueryStringToTaskDescription(taskToCheck);
    expect(appendedTaskDescription).toEqual(
      'Click link to proceed to next step [test link next step](/cases/case-details/IA/Asylum/1547652071308205/trigger/editAppealAfterSubmit?abc=123&tid=0d22d838-b25a-11eb-a18c-f2d58a9b7bc6)'
    );
  });
  ...
  it('should return task id appended to only url as querystring not to text', () => {
    const taskToCheck = task;
    taskToCheck.description =
      'Click link to proceed to next step [test link next step (testing)](/cases/case-details/IA/Asylum/1547652071308205/trigger/editAppealAfterSubmit?abc=123)';
    const appendedTaskDescription = appendTaskIdAsQueryStringToTaskDescription(taskToCheck);
    expect(appendedTaskDescription).toEqual(
      'Click link to proceed to next step [test link next step (testing)](/cases/case-details/IA/Asylum/1547652071308205/trigger/editAppealAfterSubmit?abc=123&tid=0d22d838-b25a-11eb-a18c-f2d58a9b7bc6)'
    );
  });
  ...
  it('should return fragment appended to url after taskId', () => {
    ...
    const appendedTaskDescription = appendTaskIdAsQueryStringToTaskDescription(taskToCheck);
    expect(appendedTaskDescription).toEqual(
      '[Review the Referral](/cases/case-details/${[CASE_REFERENCE]}?tid=0d22d838-b25a-11eb-a18c-f2d58a9b7bc6#Referrals)'
    );
  });
