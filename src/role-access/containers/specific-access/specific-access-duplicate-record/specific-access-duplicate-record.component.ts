...
export class SpecificAccessDuplicateRecordComponent implements OnInit {
  ...
  public ngOnInit() {
    this.taskId =
      this.activatedRoute.snapshot.data.taskAndRole &&
      this.activatedRoute.snapshot.data.taskAndRole.task &&
      this.activatedRoute.snapshot.data.taskAndRole.task.task &&
