...
import { getExpectedSubFromUserDetails } from '../../../../common/decentralisation/decentralised-redirect.util';
...
export class CaseTaskComponent implements OnInit {
  ...
  public static replaceVariablesWithRealValues(task: Task, expectedSub?: string): string {
    if (!task.description) {
      return '';
    }
