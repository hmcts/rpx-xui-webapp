...
test('Support request Add/Update Reasonable adjustment', async ({ page }) => {
  ...
  await page.goto('https://manage-case.aat.platform.hmcts.net/cases/case-create/DIVORCE/xuiCaseFlagsV1/createCase/createCasetestDataSetup');
  ...
  //Don't see case flag banner
  const caseDetailsPageContainer = await page.waitForSelector('ccd-case-full-access-view');
