...
var WriteEmailFieldComponent = /** @class */ (function (_super) {
    ...
    WriteEmailFieldComponent.prototype.ngOnInit = function () {
        this.emailControl = this.registerControl(new forms_1.FormControl(this.caseField.value));
    };
    WriteEmailFieldComponent = __decorate([
        core_1.Component({
...
//# sourceMappingURL=write-email-field.component.js.map