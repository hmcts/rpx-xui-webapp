...
var FPLCase = require('../pageObjects/FPLcase');
...
defineSupportCode(function ({ And, But, Given, Then, When }) {
    ...
    When('I create FPL case', { timeout: creatCaseStepTimeout }, async function () {
        await fplCase.createCase(false);
    })
