...
Feature: WA Release 1: Task manager
    ...
    Scenario: WITH SESSION : Task manager task counts
    ...
    Scenario: WITH SESSION : Task manager sort columns
        Given I set MOCK with user roles
            | role                      |
            | caseworker-ia-caseofficer |
            | caseworker-ia-admofficer  |
    ...
    Scenario: WITH SESSION : Task manager sort column persist in session
        Given I set MOCK with user roles
            | role                      |
            | caseworker-ia-caseofficer |
            | caseworker-ia-admofficer  |
