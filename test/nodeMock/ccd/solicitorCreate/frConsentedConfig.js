module.exports = {
  ...
  case_fields: [
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'The applicant is applying for an order by consent in terms of written agreement (a consent order). Within the draft consent order, the Applicant is applying to Court for;',
      field_type: {
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'If the application includes an application for a Property Adjustment Order in relation to land, please provide the address(es) of the property or properties, if applicable',
      field_type: {
        id: 'TextArea',
        type: 'TextArea',
        min: null,
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'If the application includes an application for a Property Adjustment Order in relation to land, please provide the name(s) and address(es) of any mortgagee(s), if applicable',
      field_type: {
        id: 'TextArea',
        type: 'TextArea',
        min: null,
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'If the application contains an application for periodical payments or secured periodical payments for children, has a written agreement made about maintenance for the benefit of children?',
      field_type: {
        id: 'YesOrNo',
        type: 'YesOrNo',
        min: null,
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'If the application contains an application for a pension sharing, pension compensation sharing, pension attachment or pension compensation attachment order, please upload the relevant pension form(s) from the list below',
      field_type: {
  ...
  event_token:
    'eyJhbGciOiJIUzI1NiJ9..5t8gV1D0eyeSvNRWoulB34EXXCZCkiRyEPOKh3YhN2M',
  wizard_pages: [
    {
      ...
      retries_timeout_mid_event: [3, 4, 5],
    },
    {
    ...
    },
    {
      ...
      callback_url_mid_event:
        'http://finrem-cos-aat.service.core-compute-aat.internal/case-orchestration/field/consentOrder/file-upload-check',
      retries_timeout_mid_event: [3, 4, 5],
    },
    {
    ...
    },
    {
      ...
      show_condition:
        'natureOfApplication2CONTAINS"Pension Sharing Order" OR natureOfApplication2CONTAINS"Pension Attachment Order" OR natureOfApplication2CONTAINS"Pension Compensation Sharing Order" OR natureOfApplication2CONTAINS"Pension Compensation Attachment Order"',
      callback_url_mid_event:
        'http://finrem-cos-aat.service.core-compute-aat.internal/case-orchestration/field/pensionCollection/file-upload-check',
      retries_timeout_mid_event: [3, 4, 5],
    },
    {
