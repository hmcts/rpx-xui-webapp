...
class PRDApi {
  constructor() {
    ...
    this.categoryTypes = {
      HearingType: {
        inputs: [
          { value_en: 'Breach 1', key: 'ABA1-BRE' },
          { value_en: 'Breach 2', key: 'ABA2-BRE' },
        ],
        value: [],
      },
      Facilities: {
        inputs: [
          { value_en: 'Facility 1', key: 'ABA1-FAC' },
          { value_en: 'Facility 2', key: 'ABA2-FAC' },
        ],
        value: [],
      },
      HearingChannel: {
      ...
      JudgeType: {
        inputs: [
          { value_en: 'Judge type 1', key: 'ABA1-JDT' },
          { value_en: 'Judge type 2', key: 'ABA2-JDT' },
        ],
        value: [],
      },
      HearingPriority: {
        inputs: [
          { value_en: 'Hearing priority 1', key: 'ABA1-HPR' },
          { value_en: 'Hearing priority 2', key: 'ABA2-HPR' },
        ],
        value: [],
      },
      caseType: {
