...
const ENV_KEYS = [
  ...
  'HEARING_MANAGER_CR84_OFF_5_USERNAME',
  'HEARING_MANAGER_CR84_OFF_5_PASSWORD',
  'HEARING_MANAGER_CR84_OFF_6_USERNAME',
  'HEARING_MANAGER_CR84_OFF_6_PASSWORD',
  'HEARING_MANAGER_CR84_OFF_7_USERNAME',
  'HEARING_MANAGER_CR84_OFF_7_PASSWORD',
  'HEARING_MANAGER_CR84_OFF_8_USERNAME',
  'HEARING_MANAGER_CR84_OFF_8_PASSWORD',
  ...
  'HEARING_MANAGER_CR84_ON_5_USERNAME',
  'HEARING_MANAGER_CR84_ON_5_PASSWORD',
  'HEARING_MANAGER_CR84_ON_6_USERNAME',
  'HEARING_MANAGER_CR84_ON_6_PASSWORD',
  'HEARING_MANAGER_CR84_ON_7_USERNAME',
  'HEARING_MANAGER_CR84_ON_7_PASSWORD',
  'HEARING_MANAGER_CR84_ON_8_USERNAME',
  'HEARING_MANAGER_CR84_ON_8_PASSWORD',
...
test.describe('Dynamic user support unit tests: pure modules', { tag: '@svc-internal' }, () => {
  ...
  test('runtime user credential env publication mirrors dynamic aliases and restores previous env values', () => {
    ...
    expect(getRuntimeUserCredentialEnvMapping(' hearing_manager_cr84_on-8 ')).toEqual({
