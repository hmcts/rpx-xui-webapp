...
​
  private createAnswer(state: State): string {
    ...
    const hrmMainModel = state.hearingRequest.hearingRequestMainModel;
    const hearingWindow = hrmMainModel.hearingDetails.hearingWindow;
    switch (hrmMainModel.hearingDetails.hearingType.toLowerCase()) {
      case 'yes':
