...
const NAT_ALLOWED_JR = {
  id: '401',
  caseReference: '0401 0401 0401 0401',
  caseName: 'Nat Allowed Jr',
  caseCategory: 'Will Fail',
  location: 'Dodgy Location',
  taskName: 'Assess errors',
  dueDate: new Date(),
...
const SORTED_BY_CASE_REFERENCE = [
  AL_REDDY_DUNNE, BRAD_REQUEST, NAT_ALLOWED, NAT_ALLOWED_JR, ANNE_SUPPORTED, SIR_VAN_ERROR,
...
const SORTED_BY_CASE_NAME = [
  ...
  EBENEZER_SCROOGE, KILI_MUSO, MANKAI_LIT, NAT_ALLOWED, NAT_ALLOWED_JR, OLIVER_TWIST, SIR_VAN_ERROR
];
...
const SORTED_BY_LOCATION = [
  EBENEZER_SCROOGE, AL_REDDY_DUNNE, BRAD_REQUEST, NAT_ALLOWED, NAT_ALLOWED_JR, ANNE_SUPPORTED,
  SIR_VAN_ERROR, OLIVER_TWIST, KILI_MUSO, DAVID_COPPERFIELD, MANKAI_LIT, BOB_CRATCHITT
];

const SORTED_BY_TASK = [
  KILI_MUSO, AL_REDDY_DUNNE, BRAD_REQUEST, NAT_ALLOWED, NAT_ALLOWED_JR, ANNE_SUPPORTED, SIR_VAN_ERROR,
...
const SORTED_BY_DUE_DATE = [
  ...
  AL_REDDY_DUNNE, BRAD_REQUEST, NAT_ALLOWED, NAT_ALLOWED_JR, ANNE_SUPPORTED, SIR_VAN_ERROR, OLIVER_TWIST
];
