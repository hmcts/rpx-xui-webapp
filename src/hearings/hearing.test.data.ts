...
// Initial state is used across by multiple specs file, some spec set changes even it is constant and led misfunction other unit tests that are different spec file
// because of afterOnInit did not solve issue we need immutable one of Initial state
