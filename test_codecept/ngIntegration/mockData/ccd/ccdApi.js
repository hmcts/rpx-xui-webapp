...
class CCDApi {
  ...
  getCaseDetailsWithID(caseId) {
    ...
    this.caseDetailsResponse._links.self.href =
      'http://ccd-data-store-api-demo.service.core-compute-demo.internal/internal/cases/' + caseId;
    ...
    switch (eventId) {
      ...
      case 'dynamicList':
        ...
        customCase.addCaseField({
          label: 'test field won label',
          type: 'DynamicList',
          id: 'dynamicListField',
          value: { value: listItems[2], list_items: listItems },
        });
        customCase.addCaseField({
          type: 'Complex',
          id: 'dynamicListInComplexField',
          complex_fields: [{ type: 'DynamicList', id: 'dynamicListField', label: 'Field Dynamic list' }],
  ...
  getCustomCase() {
    ...
    return customCase
      ...
      .addCaseField({
        ...
        type: 'Collection',
        label: 'People',
        collection_field_type: { id: 'person2', type: 'Complex', label: 'Person 2', complex_fields: personFields },
      })
      .setFieldProps({ show_condition: 'TextField0!="Hide all"' })
      .getCase();
  }
    ...
    for (let rowCounter = 0; rowCounter < 25; rowCounter++) {
      rows.push({
        ...
        case_fields: {
          ...
          solsConfirmSignSOT3:
            'The executor believes that all the information stated in the legal statement is true. They have authorised ${solsSolicitorFirmName} to sign a statement of truth on their behalf.',
          immovableEstateInfo:
            'You are unable to apply online unless the estate in England and Wales consists wholly of immovable property.',
          solicitorMainApplicantInfo:
            'You cannot apply for letters of administration if you are a solicitor applying as an executor.',
          ...
          solsDiedOrNotApplyingInfo:
            'You can’t use this service if an executor/residuary legatee/devisee in trust is alive or applying.',
          solsLifeInterestInfo: 'You can’t use this service if there is a life interest in respect of the estate.',
          solsBeforeSubmitPage:
            "* Check the information you've given. You can do this on the next pagesn* Review the legal statement and declarationn* Get authorisation from your client to confirm and sign the statement of truth on their behalf",
  ...
  complexDynamicList: () => {
    ...
    return (
      caseConfig
        ...
        .addCaseField({
          id: 'complexWithDynamicList',
          type: 'Complex',
          label: 'Comples having dynamic list',
          value: { testComplexDynamicList: dynamicListVal },
          complex_fields: [{ id: 'testComplexDynamicList', type: 'DynamicList', label: 'Complex Dynamic List' }],
        })
        .getCase()
    );
  },
