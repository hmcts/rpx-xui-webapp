...
describe('Service Ref Data', () => {
  ...
  it('should get service ref data mapping', async() => {
    ...
    const response = [{service: 'IA', serviceCodes: ['BFA1']}, { service: 'CIVIL', serviceCodes: ["AAA6" , 'AAA7']}];
  ...
  it('should get only the list of service ref data mapping', async() => {
    ...
    expect(serviceRefDataList).to.deep.equal([{service: 'IA', serviceCodes: ['BFA1']}, { service: 'CIVIL', serviceCodes: ["AAA6" , 'AAA7']}]);
  })
