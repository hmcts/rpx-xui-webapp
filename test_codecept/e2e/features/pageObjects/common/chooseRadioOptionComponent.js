...
class ChooseRadioOptionComponent {
  get component() {
    // <exui-choose-radio-option>
    return $('exui-choose-radio-option');
  }

  /* elements inside the component ------------------------------------- */
  get header() {
    return this.component.locator('h1');
  }
  get headerCaption() {
    return this.component.locator('h1 span');
  }

  // all <div class="govuk-radios"> groups inside the component
  get radioOptions() {
    return this.component.locator('.govuk-radios');
  }

  /* cross-component error message (same selector as before) ------------ */
  get errorMessage() {
    return $('exui-choose-radio-option #error-message');
  }
  ...
  async getRadioOptionInputElement(radioLabel) {
    return await this.component.locator(
