...
describe('WA Supported Jurisdictions', () => {
  ...
  it('should get supported jurisdictions', async() => {
    ...
    const response = ['IA', 'CIVIL', 'PRIVATELAW', 'PUBLICLAW', 'EMPLOYMENT', 'ST_CIC', 'EMPLOYMENT', 'SSCS'];
  ...
  it('should get only the list of supported jurisdictions', async() => {
    ...
    expect(jurisdictionList).to.deep.equal(['IA', 'CIVIL', 'PRIVATELAW', 'PUBLICLAW', 'EMPLOYMENT', 'ST_CIC', 'EMPLOYMENT', 'SSCS']);
  });
});
