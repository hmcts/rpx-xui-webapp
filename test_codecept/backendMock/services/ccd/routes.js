...
router.post('/data/case-types/:caseType/validate', (req, res) => {
  const responseBody = {
    ...
    _links: {
      self: {
        href: 'http://ccd-data-store-api-demo.service.core-compute-demo.internal' + req.path + '?pageId=' + req.query.pageId,
      },
    },
  };
...
router.post('/data/case-types/:caseType/cases', (req, res) => {
  const responseBody = {
    ...
    data: req.body.data,
    _links: {
      self: { href: 'http://ccd-data-store-api-demo.service.core-compute-demo.internal' + req.path + '?ignore-warning=false' },
    },
  };
  res.send(responseBody);
});
