...
const JUDICIAL_DATES: FieldConfig[] = [CREATED_DATE];
const STAFF_DATES: FieldConfig[] = [DUE_DATE_AS_TEXT, PRIORITY];
...
const MY_CASES: FieldConfig[] = [
  CASE_NAME_AS_LINK_DISABLE_SORT,
  JURISDICTION_DISABLE_SORT,
  CASE_CATEGORY_DISABLE_SORT,
  CASE_ROLE_DISABLE_SORT,
  NEXT_HEARING_DATE,
  START_DATE_DISABLE_SORT,
  END_DATE_DISABLE_SORT,
];
const MY_ACCESS: FieldConfig[] = [
  CASE_NAME_AS_LINK_DISABLE_SORT,
  JURISDICTION_DISABLE_SORT,
  CASE_CATEGORY_DISABLE_SORT,
  DATE_SUBMITTED_DISABLE_SORT,
  ACCESS_DISABLE_SORT,
  ACCESS_START_DATE_DISABLE_SORT,
  ACCESS_END_DATE_DISABLE_SORT,
  ACCESS_VIEW_LINK,
];
const MY_TASKS: FieldConfig[] = [
  CASE_REFERENCE_AS_LINK,
  CASE_NAME_AS_TEXT,
  CASE_CATEGORY,
  LOCATION,
  DERIVED_ICON,
...
const TASK_MANAGER: FieldConfig[] = [CASE_NAME_AS_TEXT, CASE_CATEGORY, LOCATION, TASK_NAME_AS_TEXT, ...STAFF_DATES, ASSIGNEE];
const TASK_ACTIONS: FieldConfig[] = [...MY_TASKS];
...
const ALL_WORK_CASES: FieldConfig[] = [
  CASE_NAME_AS_LINK_DISABLE_SORT,
  CASE_CATEGORY_DISABLE_SORT,
  LOCATION_DISABLE_SORT,
  ROLE_DISABLE_SORT,
  NEXT_HEARING_DATE_DISABLE_SORT,
  PERSON,
];
...
export const CONFIG_CONSTANTS_NOT_RELEASE4 = {
  AvailableTasksForJudicial: AVAILABLE_TASKS_FOR_JUDICIAL.filter(
    (task) => task.name !== 'next_hearing_date' && task.name !== 'priority'
  ),
  ...
  MyWorkTasksForJudicial: MY_WORK_TASKS_FOR_JUDICIAL.filter(
    (task) => task.name !== 'next_hearing_date' && task.name !== 'priority'
  ),
  MyWorkTasksForLegalOps: MY_WORK_TASKS_FOR_LEGAL_OPS.filter((task) => task.name !== 'next_hearing_date'),
  AllWorkTasksForJudicial: ALL_WORK_TASKS_FOR_JUDICIAL.filter(
    (task) => task.name !== 'next_hearing_date' && task.name !== 'priority'
  ),
