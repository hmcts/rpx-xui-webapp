...
test.describe(
  'rich text editor accessibility interactions @accessibility @a11y @wave-a11y',
  {
    annotation: [
      { type: 'feature', description: 'rich text editor' },
      { type: 'page-state', description: 'Outcome note editor' },
    ],
  },
  () => {
