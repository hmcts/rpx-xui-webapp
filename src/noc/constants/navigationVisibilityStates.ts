...
export const setAnswersButtonVisibilityStates = [NocState.QUESTION, NocState.ANSWER_INCOMPLETE, NocState.ANSWER_SUBMISSION_FAILURE, NocState.SUBMISSION_SUCCESS_APPROVED, NocState.SUBMISSION_SUCCESS_PENDING, NocState.SUBMISSION_FAILURE];
