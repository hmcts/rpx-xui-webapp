...
# Role Assignment for Welsh Reporting Automation Account to send emails via ACS
...
# Role Assignment for Org Approvals Automation Account to send emails via ACS
resource "azurerm_role_assignment" "org_approvals_acs_contributor" {
