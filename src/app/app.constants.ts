...
export const featureToAttributeMap = new Map<string, string>([
  [
    featureNames.waServiceConfig,
    featureToAttributeName(featureNames.waServiceConfig),
  ],
  [
    featureNames.waLandingPageRoles,
    featureToAttributeName(featureNames.waLandingPageRoles),
  ],
  ...
  [
    featureNames.secureDocumentStoreEnabled,
    "document_management_secure_enabled",
  ], // should refactor this
  [featureNames.icpEnabled, featureToAttributeName(featureNames.icpEnabled)],
  [
    featureNames.icpJurisdictions,
    featureToAttributeName(featureNames.icpJurisdictions),
  ],
  [
    featureNames.enableCaseFileViewVersion1_1,
    featureToAttributeName(featureNames.enableCaseFileViewVersion1_1),
  ],
  [
    featureNames.enableRestrictedCaseAccess,
    featureToAttributeName(featureNames.enableRestrictedCaseAccess),
  ],
  [
    featureNames.accessManagementMode,
    featureToAttributeName(featureNames.accessManagementMode),
  ],
]);
...
export class AppConstants {
  ...
  public static SERVICE_MESSAGES_FEATURE_TOGGLE_KEY =
    serviceMessagesFeatureToggleKey;
...
export const LD_FLAG_REMOVE_USER_FROM_CASE_MC: string =
  "remove-user-from-case-mc";
