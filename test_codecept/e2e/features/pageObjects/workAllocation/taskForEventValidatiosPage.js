...
class TaskForEventCompletionValidationPage {
  ...
  get validationPages() {
    return $(this._validationPageSelectors.join(','));
  }
  ...
  get errorDetailsContainer() {
    return $('div.govuk-form-group--error');
  }
  get errorDetailsHeader() {
    return $('div.govuk-form-group--error h2');
  }
  get errorDetailsMessage() {
    return $('div.govuk-form-group--error');
  }
  get errorDetailsNavLink() {
    return $('div.govuk-form-group--error a');
  }

  get continueButton() {
    return $('ccd-case-event-completion button');
  }
  get cancelButton() {
    return $('ccd-case-event-completion a.govuk-button');
  }
