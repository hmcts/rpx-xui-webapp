...
describe('AppComponent', () => {
  ...
  describe('handleTopOfPageFocus()', () => {
    ...
    const navigationEndWithContentHash = new NavigationEnd(1, '/#content', '/#content');
    ...
    it('should focus on content element', fakeAsync(() => {
      eventsSub.next(navigationStart);
      eventsSub.next(navigationEndWithContentHash);
      tick(2000);
      expect(querySelectorSpy).toHaveBeenCalledWith(contentElement);
    }));
  });
});
