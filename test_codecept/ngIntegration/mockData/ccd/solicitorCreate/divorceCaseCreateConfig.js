module.exports = {
  ...
  case_fields: [
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'Enter the petitioner\'s name exactly as it appears on the marriage certificate. Include any extra text such as "formerly known as"',
      field_type: {
        id: 'Text',
        type: 'Text',
        min: null,
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'Enter the respondent\'s name exactly as it appears on the marriage certificate. Include any extra text such as "formerly known as"',
      field_type: {
        id: 'Text',
        type: 'Text',
        min: null,
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'Is the petitioner’s current name different to their married name or the name shown on their marriage certificate?',
      field_type: {
        id: 'YesOrNo',
        type: 'YesOrNo',
        min: null,
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'Is the respondent’s current name different to their married name or the name shown on their marriage certificate?',
      field_type: {
        id: 'YesOrNo',
        type: 'YesOrNo',
        min: null,
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'If the respondent is to be served at their home address, enter the home address here and as the service address below',
      field_type: {
        id: 'TextArea',
        type: 'TextArea',
        min: null,
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'The court will not start processing your request for a financial order until you submit the separate application and pay the fee.',
      field_type: {
        id: 'YesOrNo',
        type: 'YesOrNo',
        min: null,
      ...
      field_type: {
        ...
        fixed_list_items: [
          ...
          },
          {
            code: 'B',
            label:
              'The Petitioner and Respondent were last habitually resident in England and Wales and one of them still resides there',
            order: null,
          },
          {
            code: 'A',
    ...
    },
    {
      ...
      label:
        'Please note that the information provided will be used as evidence by the court to decide if the petitioner is entitled to legally end their marriage. **A copy of this form is sent to the respondent**',
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      label:
        'You’ll need to upload evidence of the name change (e.g. marriage certificate, change of name deed, statutory declaration) later in this application.',
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      label:
        "Include what the petitioner believes they know about the adultery (the adultery that forms the basis of this petition). If the petitioner doesn't know any details of the adultery, say that they are unknown and explain why.",
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      label:
        'Do not name the person with whom the adultery was committed, unless the petitioner wishes to formally include them in the divorce proceedings.',
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      label:
        'Once named, they will usually become a co-respondent in the proceedings and will be sent copies of the application.',
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      label:
        "Include examples of the respondent's behaviour which affect the petitioner the most, and the most recent incidents. Try to include dates if available. If the petitioner thinks their health has been affected, state how it has been affected",
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      label:
        'Provide enough examples to satisfy the court that the petitioner cannot reasonably be expected to live with the respondent',
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      label:
        "The respondent must have chosen to leave the petitioner for this reason to be valid. For example, you can't use desertion if the respondent has been sent to prison.",
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      label:
        'You need to provide the following dates related to petitioner separation. The court will use the most recent separation date as the petitioner and respondent separated.',
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      label:
        'A claim for costs can include all the fees the petitioner has to pay during the divorce, such as application fees, solicitor fees and any extra court fees.',
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      label:
        'The image must be of the entire document and has to be readable by court staff. You can upload jpg, bmp, png, tif, or PDF files (max file size 10MB per file)',
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      label:
        'Divorce – *Same Sex Couple* – Marriage (Same Sex Couples) (Jurisdiction and Recognition of Judgments) Regulations 2014 for matrimonial proceedings involving same sex couples',
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'Use the same date for both if they happened on the same day. If the Petitioner not sure of the exact dates, use the closest dates that they remember.',
      field_type: {
        id: 'Date',
        type: 'Date',
        min: null,
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        "Petitioner and respondent can both live in the same property and be considered by the court to be living apart, as long as they're living separate lives. For example, they don’t eat, sleep or socialise together.",
      field_type: {
        id: 'Date',
        type: 'Date',
        min: null,
    ...
    },
    {
      ...
      label:
        'Have the petitioner and respondent lived together for more than ${D8SeparationTimeTogetherPermitted} since ${D8SeparationReferenceDate} ?',
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      label:
        "If the petitioner and respondent lived together for more than ${D8SeparationTimeTogetherPermitted} since ${D8SeparationReferenceDate} they won't have been separated for long enough to use the ${SepYears} years separation reason for divorce at this time.",
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      label:
        "If the petitioner and respondent lived together for more than ${D8DesertionTimeTogetherPermitted} since ${D8SeparationReferenceDate} they won't have been separated for long enough to use desertion as  reason for divorce at this time.",
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        "Petitioner must have lived apart from the respondent for at least 2 years since  ${D8SeparationReferenceDate}. Any time that the petitioner & respondent have lived together doesn't count towards this 2 year desertion period",
      field_type: {
        id: 'YesOrNo',
        type: 'YesOrNo',
        min: null,
    ...
    },
    {
      ...
      label:
        'Have the petitioner and respondent lived together for more than ${D8DesertionTimeTogetherPermitted} since ${D8SeparationReferenceDate} ?',
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
  ...
  event_token:
    'eyJhbGciOiJIUzI1NiJ9..lmAg9chPqCAJinPcV9O4BPgKVZm1e6ZQA3cNFcrdSRE',
  wizard_pages: [
    {
