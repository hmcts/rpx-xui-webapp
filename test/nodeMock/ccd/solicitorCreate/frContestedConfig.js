module.exports = {
  ...
  case_fields: [
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'To ensure the application is linked to the divorce file without delay, please upload a copy of the decree [nisi] [absolute]',
      field_type: {
        ...
        fixed_list_items: [
          {
            code: 'reason_4',
            label:
              'The financial remedy sought is related to an order for financial provision during a marriage or civil partnership under the Domestic Proceedings and Magistrates’ Courts Act 1978 or Schedule 6 to the Civil Partnership Act 2004',
            order: null,
          },
          {
            code: 'reason_3',
          ...
          },
          {
            code: 'reason_2',
            label:
              'The financial remedy sought is related to the recognition and enforcement of a foreign maintenance order under Article 56 of the Maintenance Regulation or Article 10 of the 2007 Hague Convention',
            order: null,
          },
          {
            code: 'reason_1',
            label:
              'The financial remedy sought is an application to vary a periodical payments order (but does not seek to dismiss the periodical payments order and substitute it with one or more of the following: a lump sum order, a property adjustment order, a pension sharing order or a pension compensation sharing order)',
            order: null,
          },
        ],
        complex_fields: [],
    ...
    },
    {
      ...
      label:
        'A complex case could be retained for hearing within the Financial Remedy Centre and/or allocated to a higher tier of Judiciary',
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
      ...
      field_type: {
        ...
        fixed_list_items: [
          ...
          },
          {
            ...
            label:
              'Assets are / were held through the medium of trusts / settlements/ family/ unquoted corporate entities or otherwise held offshore or overseas',
            order: null,
          },
          {
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'For example you need a separate waiting room to the other person, video link or protective screen due to safety concerns. The court may contact you to discuss your requirements.',
      field_type: {
        id: 'Text',
        type: 'Text',
        min: null,
    ...
    },
    {
      ...
      label:
        '## Has a family mediator informed the applicant that a mediator’s exemption applies, and they do not need to attend a MIAM ?',
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
      ...
      field_type: {
        ...
        fixed_list_items: [
          ...
          },
          {
            ...
            label:
              'At the time of making the application, the person is participating in another form of non-court dispute resolution relating to the same or substantially the same dispute',
            order: null,
          },
          {
      ...
      field_type: {
        ...
        fixed_list_items: [
          ...
          },
          {
            ...
            label:
              '(i) the prospective applicant has contacted as many authorised family mediators as have an office within fifteen miles of his or her home (or three of them if there are three or more), and all of them have stated that they are not available to conduct a MIAM within fifteen business days of the date\nof contact; and (ii) the names, postal addresses and telephone numbers\nor e-mail addresses for such authorised family mediators, and the dates of contact, can be provided to the court if requested.',
            order: null,
          },
          {
          ...
          },
          {
            ...
            label:
              'The applicant is bankrupt evidenced by a petition by a creditor of the prospective applicant for a bankruptcy order',
            order: null,
          },
          {
    ...
    },
    {
      id: 'midlandsFRCList',
      label:
        'Please choose the FRC which covers the area within which the Applicant resides - if the applicant does not reside within one of these areas, you will not yet be able to submit your application online.',
      hidden: null,
      value: null,
      metadata: false,
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'Please give the name of the Court which is closest to the Applicants home postcode. If you are unsure, please check on http://courttribunalfinder.service.gov.uk',
      field_type: {
  ...
  wizard_pages: [
    ...
    },
    {
      ...
      callback_url_mid_event:
        'http://finrem-cos-aat.service.core-compute-aat.internal/case-orchestration/miam-attend-exempt-check',
      retries_timeout_mid_event: [],
    },
    {
    ...
    },
    {
      ...
      show_condition:
        'claimingExemptionMIAM="Yes" AND applicantAttendedMIAM="No" AND familyMediatorMIAM="No" AND MIAMExemptionsChecklistCONTAINS"domesticViolence"',
      callback_url_mid_event: null,
      retries_timeout_mid_event: [],
    },
    {
      ...
      show_condition:
        'claimingExemptionMIAM="Yes" AND applicantAttendedMIAM="No" AND familyMediatorMIAM="No" AND MIAMExemptionsChecklistCONTAINS"urgency"',
      callback_url_mid_event: null,
      retries_timeout_mid_event: [],
    },
    {
      ...
      show_condition:
        'claimingExemptionMIAM="Yes" AND applicantAttendedMIAM="No" AND familyMediatorMIAM="No" AND MIAMExemptionsChecklistCONTAINS"previousMIAMattendance"',
      callback_url_mid_event: null,
      retries_timeout_mid_event: [],
    },
    {
      ...
      show_condition:
        'claimingExemptionMIAM="Yes" AND applicantAttendedMIAM="No" AND familyMediatorMIAM="No" AND MIAMExemptionsChecklistCONTAINS"other"',
      callback_url_mid_event: null,
      retries_timeout_mid_event: [],
    },
    {
