...
const caseDetailsUrl = '/cases/case-details/';

const accessViewUrl = '/access-view/';

const serviceMessagesFeatureToggleKey = 'mc-service-messages';
const serviceMessageCookie = 'service_messages';

const caseAllocatorRole = 'case-allocator-role';
...
export const LD_FLAG_REMOVE_USER_FROM_CASE_MC = 'remove-user-from-case-mc';
export const LD_FLAG_MC_APPLICATION_THEMES = 'mc-application-themes';
