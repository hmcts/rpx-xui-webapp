...
describe('Staff Supported Jurisdictions', () => {
  ...
  it('should get supported jurisdictions', async() => {
    ...
    const response = ['ST_CIC', 'CIVIL', 'EMPLOYMENT', 'PRIVATELAW', 'PUBLICLAW', 'IA', 'SSCS', 'DIVORCE', 'FR', 'HRS'];
  ...
  it('should get only the list of supported jurisdictions', async() => {
    ...
    expect(jurisdictionList).to.deep.equal(['ST_CIC', 'CIVIL', 'EMPLOYMENT', 'PRIVATELAW', 'PUBLICLAW', 'IA', 'SSCS', 'DIVORCE', 'FR', 'HRS']);
  });
});
