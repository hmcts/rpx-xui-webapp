...
test.describe('Global search', { tag: ['@api', '@svc-global-search'] }, () => {
...
test.describe('Ref data and supported jurisdictions', { tag: ['@api', '@svc-ref-data'] }, () => {
...
test.describe('Role access / AM', { tag: ['@api', '@svc-role-assignment'] }, () => {
...
test.describe('Search/refdata helper coverage', { tag: ['@api', '@svc-global-search', '@svc-ref-data'] }, () => {
