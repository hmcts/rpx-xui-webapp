...
export const USEFUL_CASEWORKERS = [JANE_DOE, JOHN_SMITH, JOSEPH_BLOGGS, NOAH_BODY];

export const USELESS_CASEWORKERS = [AL_REDDY_DUNNE, ANNE_SUPPORTED, BRAD_REQUEST, NAT_ALLOWED, SIR_VAN_ERROR];
