...
Feature: WA Release 2: Case details Tasks tab
    ...
    Scenario Outline: Task tab content displayed
        ...
        Given I set MOCK case tasks with userDetails from reference "userDetails"
            ...
            | 18a3d216-task-4e92-a7e3-ca3661e6be87 | Task 2                                    | thissession                          | Test user    | -10          | 0        | UnAssign,Assign,Own,Cancel           | true     | Click link to proceed [next step 1](/case/case-details/${[case_id]}) or \n Click link to proceed to [next step 2](/case/case-details/${[case_id]}/${[id]}/testaction2) \n Click link to proceed to [next step 3](/case/testroute?caseId=${[case_id]}/${[id]}/testaction2) |
            |                                      | Task 3                                    | someone                              | Test 7 user  | -10          | 1        | Complete                         | true     |                                                                                                                                                                                                                                                                           |
            |                                      | Task 4                                    |                                      |              | -10          | 100       |                                      | true     |                                                                                                                                                                                                                                                                           |
            |                                      | Task 5                                    |                                      |              | -10          | 200       |                                      | true     |                                                                                                                                                                                                                                                                           |
            |                                      | 6 Permissions OME assined to me           | thissession                          | Test user    | -10          | 300       | UnAssign,Assign,Own,Cancel                   | true     |                                                                                                                                                                                                                                                                           |
            |                                      | 7 Permissions OME assigned to someother   | test_id                              |               | -10          | 400       | Own,Manage,Execute                   | true     |                                                                                                                                                                                                                                                                           |
            |                                      | 8 Permissions OME unassigned              |                                      |              | -10          | 500       | Execute,UnAssignClaim                   | true     |                                                                                                                                                                                                                                                                           |
            |                                      | 9 Permissions ME assined to me            | thissession                          | Test user    | -10          | 10       | CompleteOwn                       | true     |                                                                                                                                                                                                                                                                           |
            |                                      | 10 Permissions ME assigned to someother   | 08a3d216-c6ab-4e92-a7e3-ca3661e6be87 | Test 4 user  | -10          | 10       | Complete,UnAssign,Assign                       | true     |                                                                                                                                                                                                                                                                           |
