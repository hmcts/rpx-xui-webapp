...
```html
<!-- Before -->
<select id="wb-jurisdiction" class="form-control">
  ...
</select>

<!-- After -->
<select id="wb-jurisdiction" class="form-control" data-testid="jurisdiction-select">
  ...
</select>
```
...
```html
<nav class="hmcts-primary-navigation__item" data-testid="nav-item-case-list">Case list</nav>
<nav class="hmcts-primary-navigation__item" data-testid="nav-item-create-case">Create case</nav>
```
...
<button id="next-step" class="govuk-button" type="submit" data-testid="case-action-go-button">Go</button>
```
