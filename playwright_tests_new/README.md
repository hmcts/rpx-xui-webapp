...
- `@e2e-manage-tasks` is included in the default E2E lane and exercises the dynamic organisation, dynamic solicitor, dynamic case, and dynamic WA task journey; smoke remains a separate Playwright project and Jenkins smoke stage.
