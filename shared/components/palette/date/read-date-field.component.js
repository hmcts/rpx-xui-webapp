...
var ReadDateFieldComponent = /** @class */ (function (_super) {
    __extends(ReadDateFieldComponent, _super);
    function ReadDateFieldComponent() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.timeZone = 'utc';
        return _this;
    }
    ReadDateFieldComponent = __decorate([
        core_1.Component({
