...
class AllocateRoleWorkFlow {
  ...
  get chooseRolesPage() {
    return (this._chooseRolesPage ??= new ChooseRadioOptionComponent(this.workFlowContainer.container));
  }

  get chooseHowToAllocateRolePage() {
    return (this._chooseHowToAllocateRolePage ??= new ChooseRadioOptionComponent(
  ...
  get durationOfRolePage() {
    return (this._durationOfRolePage ??= new ChooseDuration(this.workFlowContainer.container));
  }
}
