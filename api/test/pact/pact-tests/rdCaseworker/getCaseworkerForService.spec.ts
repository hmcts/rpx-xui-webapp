...
const pactSetUp = new PactTestSetup({ provider: 'rd_caseworker_ref_api_get_caseworkers_for_service', port: 8000 });

const serviceId = "IAC";
describe("Caseworker ref data api, get all caseworkers for service", () => {
    ...
    describe("get /caseworker/service/{serviceId}", () => {
        ...
        before(async () => {
            ...
            const interaction = {
                state: "returned list of caseworkers for serviceId",
                uponReceiving: "get list of caseworkers for serviceId",
                withRequest: {
                    method: "GET",
                    path: `/caseworker/service/${serviceId}`,
                    params: {
                        serviceId: serviceId
                    },
                    headers: {
        ...
        it("returns the correct response", async () => {
            ...
            const { getCaseWorkersForService } = requireReloaded('../../../../workAllocation2/index');
