...
test(
  'Session timeout - focus entry, keyboard containment and restoration @accessibility @a11y',
  {
    annotation: [
      { type: 'feature', description: 'Session timeout' },
      { type: 'page-state', description: 'Idle warning dialog' },
    ],
  },
  async ({ page }, testInfo) => {
    test.skip(
