...
- Jenkins pins `FUNCTIONAL_TESTS_WORKERS=6` for API, E2E, and cross-browser E2E, while CNP/nightly integration profiles default to 10 workers
...
- Jenkins currently runs API and E2E with **6 workers**, and integration with **10 workers**, on both Preview and AAT
...
npx playwright test --project chromium --workers=10 # Preview integration tests

# AAT:
npx playwright test --project chromium --workers=6  # AAT E2E tests
npx playwright test --project node-api --workers=6  # AAT API tests
npx playwright test --project chromium --workers=10 # AAT integration tests
