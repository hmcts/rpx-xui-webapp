...
class ViewOrEditHearingPage {
  get container() {
    return $('exui-hearing-view-edit-summary');
  }
  get headerElement() {
    return $('exui-hearing-view-edit-summary exui-hearing-summary h1');
  }
  get summaryTable() {
    return new SummaryTable('exui-hearing-view-edit-summary');
  }
  get submitUpdatedRequestBtn() {
    return $('button[type="submit"]');
  } // keep same name
  get multiValueFields() {
    return ['Reasonable adjustments', 'Does the hearing need to take place on a specific date?'];
  }
