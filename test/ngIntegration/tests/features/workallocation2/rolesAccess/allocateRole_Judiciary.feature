...
Feature: WA Release 2: Allocate Role judiciary
    ...
    Scenario Outline: Roles and access - "<Useridentifier>" - Allocate role, reserve to me
        ...
        Examples:
            ...
            | IAC_CaseOfficer_R2 | caseworker-ia-caseofficer,caseworker-ia-admofficer | Lead Judge    | 7 days         | No                   |
            | IAC_Judge_WA_R2    | caseworker-ia-iacjudge,caseworker-ia,caseworker    | Hearing judge | Indefinite     | No                   |


    Scenario Outline: Roles and access - "<Useridentifier>" - Allocate role, Allocate to another person
        Given I set MOCK with user "<Useridentifier>" and roles "<Roles>"
