...
resource "azurerm_logic_app_trigger_recurrence" "welsh_monthly_trigger" {
  ...
  interval  = 1
  schedule {
    # Run on the 6th day of each month at 15:45 UTC
    at_these_hours   = [15]
    at_these_minutes = [45]
  }
}
