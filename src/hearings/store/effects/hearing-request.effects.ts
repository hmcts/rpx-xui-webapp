  ...
  public loadHearingRequest$ = this.actions$.pipe(
      ...
      switchMap((payload) => {
        return this.hearingsService.loadHearingRequest(payload.hearingID).pipe(
          ...
          catchError((error) => {
            this.loggerService.error('Error in HearingRequestEffects:loadHearingRequest$', error);
  ...
  public submitHearingRequest$ = this.actions$.pipe(
      ...
      switchMap((payload) => {
        return this.hearingsService.submitHearingRequest(payload).pipe(
          ...
          catchError((error) => {
            this.loggerService.error('Error in HearingRequestEffects:submitHearingRequest$', error);
  ...
  public viewEditSubmitHearingRequest$ = this.actions$.pipe(
      ...
      switchMap((payload) => {
        return this.hearingsService.updateHearingRequest(payload).pipe(
          ...
          catchError((error) => {
            this.loggerService.error('Error in HearingRequestEffects:viewEditSubmitHearingRequest$', error);
