...
import { PartySubChannelsResolverService } from './party-subchannels-resolver.service';
import { provideHttpClient, withInterceptorsFromDi } from '@angular/common/http';

describe('PartySubChannelsResolverService', () => {
  ...
  beforeEach(() => {
    ...
    providers: [
        ...
        PartySubChannelsResolverService,
        LovRefDataService,
  ...
  it('should be created', () => {
    const service: PartySubChannelsResolverService = TestBed.inject(PartySubChannelsResolverService);
    expect(service).toBeTruthy();
  });

  it('resolves reference data for party channels', inject([PartySubChannelsResolverService], (service: PartySubChannelsResolverService) => {
