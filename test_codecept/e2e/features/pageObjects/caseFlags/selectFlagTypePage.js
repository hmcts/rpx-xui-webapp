...
class SelectFlagTypePage {
  ...
  get flagHeading() {
    return elementByXpath(`//ccd-select-flag-type//h1[contains(text(),"${this.flagType}")]`);
  }
  ...
  async inputValue(field, value) {
    if (field.includes('Enter a flag type')) {
      ...
      const ele = elementByXpath(
        `//ccd-select-flag-type//h1[contains(text(),'${this.flagType}')]/../..//label[contains(text(),'${value}')]/..//input`
      );
      await ele.click();
    }
  }
