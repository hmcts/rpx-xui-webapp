...
import { ConfigConstants } from 'src/work-allocation/components/constants';
import { WorkAllocationRelease2ComponentsModule } from '../../components/work-allocation.components.module';
import { TaskService, TaskSort } from 'src/work-allocation/enums';
import { Task, TaskAction, TaskFieldConfig, TaskServiceConfig, TaskSortField } from 'src/work-allocation/models/tasks';
...
describe('TaskListRelease2Component', () => {
  let component: TaskListRelease2Component;
  ...
  beforeEach((() => {
    ...
    TestBed.configureTestingModule({
      ...
      declarations: [TaskListRelease2Component, WrapperComponent],
      providers: [
