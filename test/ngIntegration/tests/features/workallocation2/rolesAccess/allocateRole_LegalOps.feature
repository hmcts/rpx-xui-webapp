...
Feature: WA Release 2: Allocate Role Legal Ops
    ...
    Scenario Outline: Roles and access - Judge user allocates judicial role "<Useridentifier>" - Allocate role, reserve to me
        ...
        Given I navigate page route "/role-access/allocate-role?userType=legalOps"
        ...
        Examples:
            ...
            | IAC_CaseOfficer_R2 | caseworker-ia-caseofficer,caseworker-ia-admofficer | Case Manager | Indefinite | No |
    ...
    Scenario Outline: Roles and access - Judge user allocates judicial role  "<Useridentifier>" - Allocate role, Allocate to another person
        ...
        Examples:
            ...
            | IAC_CaseOfficer_R2 | caseworker-ia-caseofficer,caseworker-ia-admofficer | Case Manager | Indefinite | No | judge | judge_user1@gov.uk | judge_user2@gov.uk |
    ...
    Scenario Outline: Roles and access - "<Useridentifier>" - Allocate role, reserve to me for Another period
        ...
        Examples:
            ...
            | IAC_CaseOfficer_R2 | caseworker-ia-caseofficer,caseworker-ia-admofficer | Case Manager | Another period | Yes | +1 | +2 |
    ...
    Scenario Outline: Roles and access - Legal Ops user allocates judicial role  "<Useridentifier>" - Allocate role, Allocate to another person
        ...
        Examples:
            | Useridentifier     | Roles                                              | Role       | Duration | DateInputsDisplayed? | personSearch | findPersonResult1  | findPersonResult2  |
            | IAC_Judge_WA_R2 | caseworker-ia-iacjudge,caseworker-ia,caseworker | Case Manager | 7 days | No | judge | judge_user1@gov.uk | judge_user2@gov.uk |
