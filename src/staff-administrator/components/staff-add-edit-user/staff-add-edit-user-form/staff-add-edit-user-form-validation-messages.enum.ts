export enum StaffAddEditUserFormValidationMessages {
  'first_name.required' = 'Enter the user’s first name',
  'last_name.required' = 'Enter the user’s last name',
  'email_id.required' = 'Enter an email address',
