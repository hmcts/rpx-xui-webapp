...
Feature: WA Release 2: Case events and Task completion and states when task_required is false
    ...
    Scenario Outline: Event assigned task when reassigned to someone before submit - Trigger from Active tasks
        Given I set MOCK with user "IAC_CaseOfficer_R2" and roles "<roles>,task-supervisor,case-allocator" with reference "userDetails"
    ...
    Scenario Outline: Event assigned task when unassigned to someone before submit - Trigger from Active tasks
        Given I set MOCK with user "IAC_CaseOfficer_R2" and roles "<roles>,task-supervisor,case-allocator" with reference "userDetails"
    ...
    Scenario Outline: Event assigned task when completed by someone before submit - Trigger from Active tasks
        Given I set MOCK with user "IAC_CaseOfficer_R2" and roles "<roles>,task-supervisor,case-allocator" with reference "userDetails"
        ...
        Given I set MOCK task details
            | id           | 3db21928-cbbc-task-bd91-137c7031fe17 |
            | assignee | 08a3d216-c6ab-4e92-a7e3-ca3661e6be83 |
