...
Feature: Navigation header tabs
    ...
    Scenario Outline: Primanry nav headers for user "<useridentifier>" and roles "<roles>"
        ...
        Examples:
            ...
            | IAC_CaseOfficer_R2 | caseworker-ia-caseofficer,caseworker-ia-admofficer,task-supervisor,case-allocator | My work, All work ,Case list, Create case      | Find case           |
            | IAC_Judge_WA_R1    | caseworker-ia-iacjudge,caseworker-ia,caseworker                   | Case list                                      | Find case           |
            | IAC_Judge_WA_R2 | caseworker-ia-iacjudge,caseworker-ia,caseworker, task-supervisor,case-allocator | My work, All work | Case list,Find case |
