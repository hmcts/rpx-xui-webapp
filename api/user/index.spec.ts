...
import { getActiveRoleAssignments, validateUserInfo } from './index';
...
describe('validateUserInfo', () => {
  it('should throw an error if ID field contains invalid characters', () => {
    const userInfo = {
      id: 'user-123<script>',
      forename: 'John',
      surname: 'Doe',
    ...
    expect(() => validateUserInfo(userInfo)).to.throw('Invalid id');
  });

  it('should throw an error if surname field contains invalid characters', () => {
    const userInfo = {
      id: 'user-123',
      forename: 'John',
      surname: 'Doe:script',
    ...
    expect(() => validateUserInfo(userInfo)).to.throw('Invalid character in surname');
  });

  it('should throw an error if forename field contains invalid characters', () => {
    const userInfo = {
      id: 'user-123',
      forename: 'John "<script>',
      surname: 'Doe',
      email: 'john.doe@example.com',
      roleCategory: 'admin',
      roles: ['admin'],
    ...
    expect(() => validateUserInfo(userInfo)).to.throw('Invalid character in forename');
  });

  it('should throw an error if any of the roles contain invalid characters', () => {
    const userInfo = {
      id: 'user123',
      forename: 'John',
      surname: 'Doe',
      email: 'john.doe@example.com',
      roleCategory: 'admin',
      roles: ['caseworker-"<script>'],
      active: true,
      token: 'Bearer abc123'
    };

    expect(() => validateUserInfo(userInfo)).to.throw('Invalid role');
  });

  it('should throw an error if the active field is not a boolean', () => {
    const userInfo = {
      id: 'user123',
      forename: 'John',
      surname: 'Doe',
    ...
    expect(() => validateUserInfo(userInfo)).to.throw('Invalid active state');
  });
  ...
  it('should throw an error if the token is invalid', () => {
    const userInfo = {
      ...
      roles: ['admin'],
      active: true,
      token: 'Bearer asd091d-"<script>'
    };

    expect(() => validateUserInfo(userInfo)).to.throw('Invalid token');
  });

  it('should return the userInfo object if all fields are valid', () => {
    const userInfo = {
      id: 'user123',
      forename: 'John',
      surname: 'Doe',
