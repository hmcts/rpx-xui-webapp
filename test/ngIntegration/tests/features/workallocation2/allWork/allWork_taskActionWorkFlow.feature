...
Feature: WA Release 2: All work - Task action work flows
    ...
    Scenario Outline:  Task Manage links for "<UserType>"  action "<actionLink>"
        ...
        Examples:
            ...
            | IAC_Judge_WA_R2    | Judge      | caseworker-ia-iacjudge,caseworker-ia,caseworker    | 1         | Mark as done  | Mark a task done if it has already been completed | Mark as done   | Mark a task as done if something has gone wrong and it has already been completed.            |               |
