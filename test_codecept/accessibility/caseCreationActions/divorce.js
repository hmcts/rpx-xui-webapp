  ...
  for (let actionCounter = 0; actionCounter < allActions.length; actionCounter++) {
    ...
    switch (action.action) {
      ...
      case 'select':
        ...
        actionsCollectionArray.push(
          ...pallyActions.selectOptionClick(action.locator + " option[value = '" + action.input + "']")
        );
        break;
      case 'click':
        if (action.locator.includes('option')) {
          const selectFieldcss = action.locator.split('option')[0];
...
const allActions = [
  ...
  },
  {
    ...
    action: 'pageUrlTobe',
    input:
      'https://manage-case.aat.platform.hmcts.net/cases/case-create/DIVORCE/DIVORCE/solicitorCreate/solicitorCreateSolAboutThePetitioner',
  },
  {
    locator: 'none',
    action: 'Nextpage ',
  ...
  },
  {
    ...
    action: 'pageUrlTobe',
    input:
      'https://manage-case.aat.platform.hmcts.net/cases/case-create/DIVORCE/DIVORCE/solicitorCreate/solicitorCreateSolAboutTheRespondent',
  },
  {
    locator: 'none',
    action: 'Nextpage ',
  ...
  },
  {
    ...
    action: 'pageUrlTobe',
    input:
      'https://manage-case.aat.platform.hmcts.net/cases/case-create/DIVORCE/DIVORCE/solicitorCreate/solicitorCreateSolMarriageCertificate',
  },
  {
    locator: 'none',
    action: 'Nextpage ',
  ...
  },
  {
    ...
    action: 'pageUrlTobe',
    input:
      'https://manage-case.aat.platform.hmcts.net/cases/case-create/DIVORCE/DIVORCE/solicitorCreate/solicitorCreateSolJurisdiction',
  },
  {
    locator: 'none',
    action: 'Nextpage ',
  ...
  },
  {
    ...
    action: 'pageUrlTobe',
    input:
      'https://manage-case.aat.platform.hmcts.net/cases/case-create/DIVORCE/DIVORCE/solicitorCreate/solicitorCreateSolReasonForDivorce',
  },
  {
    locator: 'none',
    action: 'Nextpage ',
  ...
  },
  {
    ...
    action: 'pageUrlTobe',
    input:
      'https://manage-case.aat.platform.hmcts.net/cases/case-create/DIVORCE/DIVORCE/solicitorCreate/solicitorCreateSolSOCSeparation',
  },
  {
    locator: 'none',
    action: 'Nextpage ',
  ...
  },
  {
    ...
    action: 'pageUrlTobe',
    input:
      'https://manage-case.aat.platform.hmcts.net/cases/case-create/DIVORCE/DIVORCE/solicitorCreate/solicitorCreateSolSOCLivedApart',
  },
  {
    locator: 'none',
    action: 'Nextpage ',
  ...
  },
  {
    ...
    action: 'pageUrlTobe',
    input:
      'https://manage-case.aat.platform.hmcts.net/cases/case-create/DIVORCE/DIVORCE/solicitorCreate/solicitorCreateSolExistingCourtCases',
  },
  {
    locator: 'none',
    action: 'Nextpage ',
  ...
  },
  {
    ...
    action: 'pageUrlTobe',
    input:
      'https://manage-case.aat.platform.hmcts.net/cases/case-create/DIVORCE/DIVORCE/solicitorCreate/solicitorCreateSolDividingMoneyAndProperty',
  },
  {
    locator: 'none',
    action: 'Nextpage ',
  ...
  },
  {
    ...
    action: 'pageUrlTobe',
    input:
      'https://manage-case.aat.platform.hmcts.net/cases/case-create/DIVORCE/DIVORCE/solicitorCreate/solicitorCreateSolApplyToClaimCosts',
  },
  {
    locator: 'none',
    action: 'Nextpage ',
  ...
  },
  {
    ...
    action: 'pageUrlTobe',
    input:
      'https://manage-case.aat.platform.hmcts.net/cases/case-create/DIVORCE/DIVORCE/solicitorCreate/solicitorCreateSolUploadDocs',
  },
  {
    locator: 'none',
    action: 'Nextpage ',
