...
var WritePhoneUKFieldComponent = /** @class */ (function (_super) {
    ...
    WritePhoneUKFieldComponent.prototype.ngOnInit = function () {
        this.phoneUkControl = this.registerControl(new forms_1.FormControl(this.caseField.value));
    };
    WritePhoneUKFieldComponent = __decorate([
        core_1.Component({
...
//# sourceMappingURL=write-phone-uk-field.component.js.map