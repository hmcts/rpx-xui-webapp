...
describe('Auth Module', () => {
  ...
  describe('successCallback', () => {
    ...
    it('should set session and cookies successfully', () => {
      ...
      expect(res.cookie).to.have.been.calledWith('xui-mo-webapp-userId', 'test-user-id', { sameSite: 'strict', secure: true });
      expect(res.cookie).to.have.been.calledWith('xui-mo-webapp-token', 'test-access-token', { sameSite: 'strict', secure: true });
    });
    ...
    it('should handle missing user info gracefully', () => {
      ...
      expect(res.cookie).to.have.been.calledWith('xui-mo-webapp-userId', undefined, { sameSite: 'strict', secure: true });
      expect(res.cookie).to.have.been.calledWith('xui-mo-webapp-token', undefined, { sameSite: 'strict', secure: true });
    });
  });
