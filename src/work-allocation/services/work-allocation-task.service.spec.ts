...
describe('WorkAllocation', () => {
  ...
  describe('WorkAllocationTaskService', () => {
    ...
    it('searchTask should make correct api call', () => {
      ...
      service.searchTask({ searchRequest, view, refined: true});
      expect(mockHttpService.post).toHaveBeenCalledWith('/workallocation/task', { searchRequest, view , refined: true});
    });
  });
});
