...
Feature: WA Release 2: Case details Tasks tab
    ...
    Scenario Outline: Task tab content displayed
        ...
        Given I set MOCK case tasks with userDetails from reference "userDetails"
            ...
            | 08a3d216-task-4e92-a7e3-ca3661e6be87 | Task 1                                    | 3db21928-cbbc-4364-bd91-137c7031fe17 | Test user    | -10          | -1       | Own,Read,Refer,Manage,Execute,Cancel | true     | Click link to proceed to next step [test link next step](/case/case-details/${[case_id]})                                                                                                                                                                                 |
            | 18a3d216-task-4e92-a7e3-ca3661e6be87 | Task 2                                    | 3db21928-cbbc-4364-bd91-137c7031fe17 | Test 2 user  | -10          | 0        | Own,Manage,Execute                   | true     | Click link to proceed [next step 1](/case/case-details/${[case_id]}) or \n Click link to proceed to [next step 2](/case/case-details/${[case_id]}/${[id]}/testaction2) \n Click link to proceed to [next step 3](/case/testroute?caseId=${[case_id]}/${[id]}/testaction2) |
            |                                      | Task 3                                    |                                      |              | -10          | 1        | Own,Manage,Execute                   | true     |                                                                                                                                                                                                                                                                           |
            |                                      | Task 4                                    |                                      |              | -10          | 10       |                                      | true     |                                                                                                                                                                                                                                                                           |
            |                                      | Task 5                                    |                                      |              | -10          | 10       |                                      | true     |                                                                                                                                                                                                                                                                           |
            |                                      | 6 Permissions OME assined to me           | 3db21928-cbbc-4364-bd91-137c7031fe17 | Test user    | -10          | 10       | Own,Manage,Execute                   | true     |                                                                                                                                                                                                                                                                           |
            ...
            |                                      | 9 Permissions ME assined to me            | 3db21928-cbbc-4364-bd91-137c7031fe17 | Test user    | -10          | 10       | Manage,Execute                       | true     |                                                                                                                                                                                                                                                                           |
