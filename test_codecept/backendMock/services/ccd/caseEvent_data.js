  ...
  return {
    ...
    case_fields: [
      ...
      },
      {
        id: 'hasNewMatters',
        label:
          'Are there any new reasons your client wishes to remain in the UK or any new grounds on which they should be permitted to stay?',
        hidden: null,
        value: 'Yes',
        metadata: false,
        hint_text: null,
      ...
      },
      {
        ...
        metadata: false,
        hint_text:
          'You can usually find this stamped on the envelope. Alternatively enter the\ndate given on the decision letter.\n\nFor example, 03 04 2019',
        field_type: {
          id: 'Date',
          type: 'Date',
          min: null,
      ...
      },
      {
        ...
        metadata: false,
        hint_text:
          'Your GWF reference number was given to you when you first applied. You can find it on emails and letters from the Home Office about your application. For example GWF12345667',
        field_type: {
          id: 'Text',
          type: 'Text',
          min: null,
    ...
    event_token:
      'eyJhbGciOiJIUzI1NiJ9..ORjv4hg3Eg9BaFz6K-vPxpwqLMtbssUEBYynRCZpoTc',
    wizard_pages: [
      {
      ...
      },
      {
        ...
        show_condition:
          'isOutOfCountryEnabled="Yes" AND appellantInUk!="Yes" AND outOfCountryDecisionType!="refusalOfProtection" AND outOfCountryDecisionType!="removalOfClient"',
        callback_url_mid_event: null,
        retries_timeout_mid_event: [],
      },
      {
      ...
      },
      {
        ...
        show_condition:
          'appellantInUk="Yes" OR outOfCountryDecisionType!="refusalOfHumanRights" AND outOfCountryDecisionType!="refusePermit"',
