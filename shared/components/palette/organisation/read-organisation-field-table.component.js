...
var ReadOrganisationFieldTableComponent = /** @class */ (function (_super) {
    __extends(ReadOrganisationFieldTableComponent, _super);
    function ReadOrganisationFieldTableComponent(organisationService, organisationConverter) {
    ...
    ReadOrganisationFieldTableComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ], ReadOrganisationFieldTableComponent.prototype, "caseFields", void 0);
    ReadOrganisationFieldTableComponent = __decorate([
        core_1.Component({
    ...
    return ReadOrganisationFieldTableComponent;
...
//# sourceMappingURL=read-organisation-field-table.component.js.map