...
const MY_ACCESS: FieldConfig[] = [
  CASE_NAME_AS_LINK_DISABLE_SORT, JURISDICTION_DISABLE_SORT, CASE_CATEGORY_DISABLE_SORT, DATE_SUBMITTED_DISABLE_SORT, ACCESS_DISABLE_SORT, ACCESS_START_DATE_DISABLE_SORT, END_DATE_DISABLE_SORT
];
