...
import { HearingActualPartySubChannelResolverService } from './hearing-actual-party-subchannel-resolver.service';
import { provideHttpClient, withInterceptorsFromDi } from '@angular/common/http';

describe('HearingActualPartySubChannelResolverService', () => {
  ...
  beforeEach(() => {
    ...
    providers: [
        ...
        HearingActualPartySubChannelResolverService,
        LovRefDataService,
  ...
  it('should be created', () => {
    const service: HearingActualPartySubChannelResolverService = TestBed.inject(HearingActualPartySubChannelResolverService);
    expect(service).toBeTruthy();
  });

  it('resolves reference data for party channels', inject([HearingActualPartySubChannelResolverService], (service: HearingActualPartySubChannelResolverService) => {
