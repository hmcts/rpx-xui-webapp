...
const mathingPreviewToDemo = prToTestInDemo.filter(
  (conf) => process.env.TEST_URL && process.env.TEST_URL.includes(conf.previewUrl)
);
...
function getTestENVFromEnvironment() {
  return process.env.TEST_ENV !== undefined && (process.env.TEST_ENV.includes('aat') || process.env.TEST_ENV.includes('demo'))
  ...
  users: {
    aat: [
      ...
      },
      {
        ...
        release: 'wa_release_1',
        userIdentifier: 'IAC_AdmOfficer_R1',
        key: 'Welcome01',
      },
      {
        ...
        release: 'wa_release_2',
        userIdentifier: 'IAC_AdmOfficer_R2',
        key: 'Welcome01',
      },
      {
      ...
      },
      {
        ...
        release: 'wa_release_2',
        userIdentifier: 'IAC_Judge_WA_R2_CaseAllocator',
        key: 'Welcome01',
      },
...

      {
        ...
        release: 'wa_release_1',
        userIdentifier: 'IAC_CaseOfficer_R1_withoutPagination',
        key: 'Welcome01',
      },
      {
        ...
        release: 'general',
        userIdentifier: 'CASEWORKER_GLOBALSEARCH',
        key: 'Welcome01',
      },
      {
        idamId: 'ae28c49a-ad0f-467a-a480-15fcaa66165d',
      ...
      },
      {
        ...
        email: 'exuigsuser@mailinator.com',
        release: 'general',
        userIdentifier: 'WA2_GLOBAL-SEARCH',
        key: 'Welcome01',
      },
      {
      ...
      },
      {
        ...
        release: 'restricted-case-access-on',
        userIdentifier: 'RESTRICTED_CASE_ACCESS_ON',
        key: 'Welcome01',
      },
      {
        idamId: '2dacadcc-1c6a-4251-87f8-8c0ef4d68ba7',
        email: 'xui_restricted_case_access_off@mailinator.com',
        release: 'restricted-case-access-off',
        userIdentifier: 'RESTRICTED_CASE_ACCESS_OFF',
        key: 'Welcome01',
      },
      {
      ...
      },
      {
        ...
        release: 'hearing_CR84',
        userIdentifier: 'HEARING_MANAGER_CR84_ON',
        key: 'Monday01',
      },
      {
        ...
        release: 'hearing_CR84',
        userIdentifier: 'HEARING_MANAGER_CR84_OFF',
        key: 'Monday01',
      },
      {
