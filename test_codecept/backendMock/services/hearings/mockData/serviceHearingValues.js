  ...
  parties: [
    ...
    },
    {
      ...
      individualDetails: {
        ...
        hearingChannelEmail: ['solicitor@TEST.COM'],
      },
    },
    {
      ...
      individualDetails: {
        ...
        vulnerableFlag: false,
        vulnerabilityDetails: '',
        hearingChannelEmail: ['repondent1@example.net'],
        hearingChannelPhone: [],
        relatedParties: [],
      },
    },
    {
      ...
      individualDetails: {
        ...
        vulnerableFlag: false,
        vulnerabilityDetails: '',
        hearingChannelEmail: ['respondent2@example.net'],
        hearingChannelPhone: [],
        relatedParties: [],
      },
    },
    {
      ...
      individualDetails: {
        ...
        vulnerableFlag: false,
        vulnerabilityDetails: '',
        hearingChannelEmail: ['respondent3@example.net'],
        hearingChannelPhone: [],
        relatedParties: [],
      },
    },
