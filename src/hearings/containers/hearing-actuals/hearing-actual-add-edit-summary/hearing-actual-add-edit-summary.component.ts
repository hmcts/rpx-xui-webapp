...
export class HearingActualAddEditSummaryComponent implements OnInit, OnDestroy {
  ...
  public isHearingActualsDaysAvailable(hearingDate: string) {
    const hearingInfo = this.hearingActualsMainModel.hearingActuals && this.hearingActualsMainModel.hearingActuals.actualHearingDays.find((hearingInfo) => hearingInfo.hearingDate === hearingDate);
