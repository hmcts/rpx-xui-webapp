...
export class PartySubChannelsResolverService extends RefDataResolver implements Resolve<LovRefDataModel[]> {
  constructor(
  ...
  public resolve(route: ActivatedRouteSnapshot): Observable<LovRefDataModel[]> {
    route.data.category = HearingCategory.HearingSubChannel;
